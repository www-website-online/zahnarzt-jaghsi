I18N = {
    "de": {
        ...
        "gallery_p": "Entdecken Sie unsere Räume und gewinnen Sie einen Eindruck von unserer Praxis.",
    ...
    "ar": {
        ...
        "gallery_p": "تعرفوا على مرافق العيادة وأجوائها قبل زيارتكم.",
...
I18N['de'].update({
    'contact_unavailable': 'Bitte kontaktieren Sie uns derzeit telefonisch oder buchen Sie Ihren Termin über Doctolib.',
    'contact_failed': 'Ihre Nachricht konnte nicht übermittelt werden. Bitte versuchen Sie es später erneut oder rufen Sie uns an.',
    'contact_invalid': 'Bitte prüfen Sie Name, E-Mail-Adresse und Nachricht.',
    'contact_rate_limit': 'Zu viele Anfragen. Bitte warten Sie zehn Minuten oder rufen Sie uns an.',
    'contact_success': 'Vielen Dank. Ihre Nachricht wurde vom Mailserver zur Zustellung angenommen.',
})
I18N['ar'].update({
    'contact_unavailable': 'يرجى التواصل معنا هاتفياً حالياً أو حجز موعد عبر Doctolib.',
    'contact_failed': 'تعذر إرسال رسالتكم. يرجى المحاولة لاحقاً أو الاتصال بنا هاتفياً.',
    'contact_invalid': 'يرجى التحقق من الاسم والبريد الإلكتروني والرسالة.',
    'contact_rate_limit': 'طلبات كثيرة. يرجى الانتظار عشر دقائق أو الاتصال بنا هاتفياً.',
    'contact_success': 'شكراً لكم. قَبِل خادم البريد رسالتكم للتسليم.',
})
